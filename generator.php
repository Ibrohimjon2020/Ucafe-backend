...
function make_crud($data, $attributes = '', $migrations = [], $validations = [])
{
    ...
    $fileNames = ['app/Models/Product', 'app/Http/Requests/StoreProductRequest', 'app/Http/Requests/UpdateProductRequest', 'app/Http/Controllers/ProductController', 'app/Repositories/ProductRepository', 'app/Services/ProductService'];
